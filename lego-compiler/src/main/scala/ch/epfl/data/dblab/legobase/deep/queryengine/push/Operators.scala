...
{
  __ifThenElse(infix_$eq$eq(self.result, unit(null)), self.open(), unit(()));
  self.result
}
    }
}
...
trait LeftOuterJoinOpOps extends Base with MultiMapOps with OperatorOps { this: ch.epfl.data.dblab.legobase.deep.DeepDSL =>  
  ...
  implicit class LeftOuterJoinOpRep[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) {
     def open() : Rep[Unit] = leftOuterJoinOpOpen[A, B, C](self)(typeA, typeB, typeC, mb)
     def next() : Rep[Unit] = leftOuterJoinOpNext[A, B, C](self)(typeA, typeB, typeC, mb)
     def reset() : Rep[Unit] = leftOuterJoinOpReset[A, B, C](self)(typeA, typeB, typeC, mb)
     def consume(tuple : Rep[Record]) : Rep[Unit] = leftOuterJoinOpConsume[A, B, C](self, tuple)(typeA, typeB, typeC, mb)
     def defaultB : Rep[Record] = leftOuterJoinOp_Field_DefaultB[A, B, C](self)(typeA, typeB, typeC)
     ...
     def mb : Rep[Manifest[B]] = leftOuterJoinOp_Field_Mb[A, B, C](self)(typeA, typeB, typeC)
  ...
  val LeftOuterJoinOp_Field_Mb = LeftOuterJoinOpIRs.LeftOuterJoinOp_Field_Mb
  type LeftOuterJoinOp_Field_Mb[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C] = LeftOuterJoinOpIRs.LeftOuterJoinOp_Field_Mb[A, B, C]
  ...
  // method definitions
   def leftOuterJoinOpNew[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](leftParent : Rep[Operator[A]], rightParent : Rep[Operator[B]], joinCond : Rep[((A,B) => Boolean)], leftHash : Rep[((A) => C)], rightHash : Rep[((B) => C)])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[LeftOuterJoinOp[A, B, C]] = LeftOuterJoinOpNew[A, B, C](leftParent, rightParent, joinCond, leftHash, rightHash)
   def leftOuterJoinOpOpen[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = LeftOuterJoinOpOpen[A, B, C](self)
   def leftOuterJoinOpNext[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = LeftOuterJoinOpNext[A, B, C](self)
   def leftOuterJoinOpReset[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = LeftOuterJoinOpReset[A, B, C](self)
   def leftOuterJoinOpConsume[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]], tuple : Rep[Record])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = LeftOuterJoinOpConsume[A, B, C](self, tuple)
   def leftOuterJoinOp_Field_DefaultB[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C]) : Rep[Record] = LeftOuterJoinOp_Field_DefaultB[A, B, C](self)
   ...
   def leftOuterJoinOp_Field_Mb[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C]) : Rep[Manifest[B]] = LeftOuterJoinOp_Field_Mb[A, B, C](self)
...
private implicit val tagC = typeC.typeTag
    ...
    val typeTag = scala.reflect.runtime.universe.typeTag[LeftOuterJoinOp[A, B, C]]
      ...
      implicit def typeLeftOuterJoinOp[A <: ch.epfl.data.sc.pardis.shallow.Record: TypeRep, B <: ch.epfl.data.sc.pardis.shallow.Record: TypeRep, C: TypeRep]: TypeRep[LeftOuterJoinOp[A, B, C]] = LeftOuterJoinOpType(implicitly[TypeRep[A]], implicitly[TypeRep[B]], implicitly[TypeRep[C]])
  // case classes
  case class LeftOuterJoinOpNew[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](leftParent : Rep[Operator[A]], rightParent : Rep[Operator[B]], joinCond : Rep[((A,B) => Boolean)], leftHash : Rep[((A) => C)], rightHash : Rep[((B) => C)])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C], val mb : Manifest[B]) extends ConstructorDef[LeftOuterJoinOp[A, B, C]](List(typeA, typeB, typeC), "LeftOuterJoinOp", List(List(leftParent,rightParent), List(joinCond), List(leftHash), List(rightHash))){
    override def curriedConstructor = (copy[A, B, C] _).curried
  }

  case class LeftOuterJoinOpOpen[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C], val mb : Manifest[B]) extends FunctionDef[Unit](Some(self), "open", List(List())){
    override def curriedConstructor = (copy[A, B, C] _)
  }

  case class LeftOuterJoinOpNext[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C], val mb : Manifest[B]) extends FunctionDef[Unit](Some(self), "next", List(List())){
    override def curriedConstructor = (copy[A, B, C] _)
  }

  case class LeftOuterJoinOpReset[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C], val mb : Manifest[B]) extends FunctionDef[Unit](Some(self), "reset", List(List())){
    override def curriedConstructor = (copy[A, B, C] _)
  }

  case class LeftOuterJoinOpConsume[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]], tuple : Rep[Record])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C], val mb : Manifest[B]) extends FunctionDef[Unit](Some(self), "consume", List(List(tuple))){
    override def curriedConstructor = (copy[A, B, C] _).curried
  }

  case class LeftOuterJoinOp_Field_DefaultB[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C]) extends FieldDef[Record](self, "defaultB"){
    override def curriedConstructor = (copy[A, B, C] _)
    override def isPure = true

    override def partialEvaluate(children: Any*): Record = {
  ...
  case class LeftOuterJoinOp_Field_Mb[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit val typeA : TypeRep[A], val typeB : TypeRep[B], val typeC : TypeRep[C]) extends FieldDef[Manifest[B]](self, "mb"){
    override def curriedConstructor = (copy[A, B, C] _)
    override def isPure = true

    override def partialEvaluate(children: Any*): Manifest[B] = {
      val self = children(0).asInstanceOf[LeftOuterJoinOp[A, B, C]]
      self.mb
    }
    override def partialEvaluable: Boolean = true
...
trait LeftOuterJoinOpImplementations extends LeftOuterJoinOpOps { this: ch.epfl.data.dblab.legobase.deep.DeepDSL => 
    override def leftOuterJoinOpOpen[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = {
{
  self.leftParent.child_$eq(self);
  self.leftParent.open();
  self.rightParent.child_$eq(self);
  self.rightParent.open()
    ...
    override def leftOuterJoinOpNext[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = {
{
  self.rightParent.next();
  self.mode_$eq(unit(1));
  self.leftParent.next()
    ...
    override def leftOuterJoinOpReset[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = {
{
  self.rightParent.reset();
  self.leftParent.reset();
  self.hm.clear()
    ...
    override def leftOuterJoinOpConsume[A <: ch.epfl.data.sc.pardis.shallow.Record, B <: ch.epfl.data.sc.pardis.shallow.Record, C](self : Rep[LeftOuterJoinOp[A, B, C]], tuple : Rep[Record])(implicit typeA : TypeRep[A], typeB : TypeRep[B], typeC : TypeRep[C], mb : Manifest[B]) : Rep[Unit] = {
__ifThenElse(infix_$eq$eq(self.mode, unit(0)), {
  val k: this.Rep[C] = __app[B, C](self.rightHash).apply(infix_asInstanceOf[B](tuple));
  {
    self.hm.addBinding(k, infix_asInstanceOf[B](tuple));
  ...
  __ifThenElse(hmGet.nonEmpty, {
    ...
    tmpBuffer.foreach[Unit](__lambda(((bufElem: this.Rep[B]) => {
      val elem: this.Rep[ch.epfl.data.sc.pardis.shallow.DynamicCompositeRecord[A, _ >: B <: ch.epfl.data.sc.pardis.shallow.Record]] = __ifThenElse(__app[A, B, Boolean](self.joinCond).apply(infix_asInstanceOf[A](tuple), bufElem), RecordOps[A](infix_asInstanceOf[A](tuple)).concatenateDynamic[B](bufElem, unit(""), unit("")), RecordOps[A](infix_asInstanceOf[A](tuple)).concatenateDynamic[ch.epfl.data.sc.pardis.shallow.Record](self.defaultB, unit(""), unit("")));
      self.child.consume(elem)
    })))
  }, self.child.consume(RecordOps[A](infix_asInstanceOf[A](tuple)).concatenateDynamic[ch.epfl.data.sc.pardis.shallow.Record](self.defaultB, unit(""), unit(""))))
})
    }
}
...
trait OperatorDynamicDispatch extends OperatorComponent { this: ch.epfl.data.dblab.legobase.deep.DeepDSL =>  
  override def operatorOpen[A](self : Rep[Operator[A]])(implicit typeA : TypeRep[A]) : Rep[Unit] = self match {
    ...
    case Def(node: LeftOuterJoinOpNew[_, _, _]) => 
      ...
      leftOuterJoinOpOpen[T1, T2, T3](self.asInstanceOf[Rep[LeftOuterJoinOp[T1, T2, T3]]])(newNode.typeA, newNode.typeB, newNode.typeC, newNode.mb)
  ...
  override def operatorNext[A](self : Rep[Operator[A]])(implicit typeA : TypeRep[A]) : Rep[Unit] = self match {
    ...
    case Def(node: LeftOuterJoinOpNew[_, _, _]) => 
      ...
      type T3 = Any
      val newNode = node.asInstanceOf[LeftOuterJoinOpNew[T1, T2, T3]]
      leftOuterJoinOpNext[T1, T2, T3](self.asInstanceOf[Rep[LeftOuterJoinOp[T1, T2, T3]]])(newNode.typeA, newNode.typeB, newNode.typeC, newNode.mb)
  ...
  override def operatorReset[A](self : Rep[Operator[A]])(implicit typeA : TypeRep[A]) : Rep[Unit] = self match {
    ...
    case Def(node: LeftOuterJoinOpNew[_, _, _]) => 
      ...
      type T3 = Any
      val newNode = node.asInstanceOf[LeftOuterJoinOpNew[T1, T2, T3]]
      leftOuterJoinOpReset[T1, T2, T3](self.asInstanceOf[Rep[LeftOuterJoinOp[T1, T2, T3]]])(newNode.typeA, newNode.typeB, newNode.typeC, newNode.mb)
  ...
  override def operatorConsume[A](self : Rep[Operator[A]], tuple : Rep[Record])(implicit typeA : TypeRep[A]) : Rep[Unit] = self match {
    ...
    case Def(node: LeftOuterJoinOpNew[_, _, _]) => 
      ...
      type T3 = Any
      val newNode = node.asInstanceOf[LeftOuterJoinOpNew[T1, T2, T3]]
      leftOuterJoinOpConsume[T1, T2, T3](self.asInstanceOf[Rep[LeftOuterJoinOp[T1, T2, T3]]], tuple)(newNode.typeA, newNode.typeB, newNode.typeC, newNode.mb)
