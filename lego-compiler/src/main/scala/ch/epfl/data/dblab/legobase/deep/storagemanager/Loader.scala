...
trait LoaderOps extends Base with LegobaseScannerOps with ArrayOps with OptimalStringOps { this: ch.epfl.data.dblab.legobase.deep.DeepDSL =>  
  // Type representation
  ...
  object Loader {
     ...
     def loadString(size : Rep[Int], s : Rep[LegobaseScanner]) : Rep[OptimalString] = loaderLoadStringObject(size, s)
  ...
  // method definitions
   ...
   def loaderLoadStringObject(size : Rep[Int], s : Rep[LegobaseScanner]) : Rep[OptimalString] = LoaderLoadStringObject(size, s)
...
object LoaderIRs extends Base {
  ...
  case class LoaderLoadStringObject(size : Rep[Int], s : Rep[LegobaseScanner]) extends FunctionDef[OptimalString](None, "Loader.loadString", List(List(size,s))){
...
trait LoaderImplementations extends LoaderOps { this: ch.epfl.data.dblab.legobase.deep.DeepDSL => 
    override def loaderLoadStringObject(size : Rep[Int], s : Rep[LegobaseScanner]) : Rep[OptimalString] = {
{
